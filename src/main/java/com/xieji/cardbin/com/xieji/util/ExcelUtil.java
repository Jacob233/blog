 ...
 * @description
 * @see <a>http://blog.csdn.net/u010670151/article/details/52635998</>
 * @Version 1.0
 * @History <li>Author: ji.xie</li>
 * <li>Date: 2018/2/6 11:36</li>
 * <li>Version: 1.0</li>
...
public class ExcelUtil {
    ...
    public static void writeExcelTest(ArrayList<ArrayList<Object>> result,String path){
        if(result == null){
            return;
        }
